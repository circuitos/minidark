...
MDS.CONTENT = {
  ...
  seq: {
    ...
    paste: "PASTE",
    clear: "CLEAR",
    help: "click: step on/off · right-click: accent · mouse-wheel on a step: change note (melody rows) · the keyboard below sets the note used for new steps",
  ...
  export: {
    ...
    mp3Unavailable: "MP3 encoder (lamejs from cdnjs) failed to load — exports fall back to WAV. Check your network and reload to retry.",
  ...
  tooltips: {
    ...
    scaleLock: { what: "Snaps every note you play or program to the minor scale of the current key.", why: "With this on you literally cannot hit a wrong note — ideal while you learn." },
    ...
    stepGrid: { what: "Each row is a track, each square a 16th-note step. Click to turn a step on.", why: "Drum machines made this grid famous — whole genres live inside these 16 squares." },
    ...
    detune: { what: "Pushes oscillator 2 slightly out of tune, in cents.", why: "A few cents of detune makes a synth shimmer; zero sounds sterile — sometimes that's the point." },
    ...
    mComp: { what: "'Glue' compression on everything — evens out peaks so the mix feels solid.", why: "Machine music wants a firm, even loudness; this also protects your ears and speakers." },
  ...
  glossary: [
    ...
    ["Pulse / Square wave", "A hollow, woody waveform — only odd harmonics. Cold and clipped; a synth-pop staple."],
    ...
    ["Sample rate", "How many audio snapshots per second a digital system takes. CD standard is 44100 — what exports here use."],
  ...
  lessons: [
    ...
    },
    {
      ...
      steps: [
        { text: "A drum machine is a grid: 16 boxes = one bar, each box a 16th note. Click boxes below to program a KICK. Try the classic: boxes 1, 5, 9, 13 — 'four on the floor'. Then press PLAY.", demo: "drumgrid" },
        { text: "Now break it. Remove the kick on 13, or add one on 11 — feel how one box changes the whole groove. Every drum sound in this app is SYNTHESIZED (the kick is a sine wave whose pitch drops fast) — no recordings anywhere.", demo: "drumgrid" },
