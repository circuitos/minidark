/* ============================================================================
   ...
   Sections:  app chrome · transport · sequencer · panels · library names ·
              library lore (libInfo: real-world anchor + Wikipedia link +
              glossary cross-refs, one per sound; validate.mjs enforces) ·
...
MDS.CONTENT = {
  ...
  inst: {
    ...
    decay: "DECAY", bright: "BRIGHT", pick: "PICK POS", body: "BODY",
    waves: { saw: "saw", pulse: "pulse", square: "square", triangle: "tri", sine: "sine" },
    sigNodes: { osc: "OSC", gen: "GEN", sample: "SMPL", string: "STRING", filter: "FILTER", amp: "AMP", sends: "FX SENDS", master: "MASTER" },
  },
  ...
  lib: {
    title: "SOUND LIBRARY",
    all: "ALL",
    cats: { drums: "DRUMS", bass: "BASS", lead: "LEAD", pad: "PAD", fm: "FM / KEYS", guitar: "GUITAR", fxhit: "FX HITS" },
    assign: "USE ON TRACK",
    previewHint: "click a sound to hear it; ⓘ tells you where it comes from; USE ON TRACK loads it on the selected track",
    ...
    infoBtn: "ⓘ",
    infoWiki: "Wikipedia ↗",
    samplesTitle: "YOUR SAMPLES",
    import: "IMPORT AUDIO…",
    samplesHint: "Import short audio files (WAV, MP3, OGG): each becomes an instrument you can put on any track, repitch with the keyboard, and feed to the FX. Samples are saved inside your project file.",
    samplesEmpty: "Nothing here yet. A door slam, a spoken word, one hit from a jam: anything short works.",
  ...
  libNames: {
    ...
    gtrSteel: "Steel String", gtrNylon: "Nylon Dusk", gtrClean: "Chrome Clean",
    gtrMute: "Palm Mute", gtrCrunch: "Junk Crunch", gtrStack: "Amp Wall",
  },

  /* ──────────────────────────────────────────────────────────────────────
     LIBRARY LORE: one entry per sound. {text}: the real machine, record or
     scene the sound is anchored to. {wiki}: a reputable link to read more.
     {terms}: glossary cross-references (must match glossary term names
     exactly; validate.mjs checks all three fields for every library entry).
     ────────────────────────────────────────────────────────────────────── */
  libInfo: {
    kick808: { text: "The boom of the Roland TR-808: a sine wave whose pitch drops fast, synthesized here exactly like the original circuit's trick. It flopped in 1980, then became the most borrowed drum sound in history.",
      wiki: "https://en.wikipedia.org/wiki/Roland_TR-808", terms: ["Roland TR-808", "Sine wave"] },
    kick909: { text: "Modeled on the Roland TR-909 kick: harder attack, shorter boom. From 1983 on it drove techno, new beat, and the EBM dancefloors of Front 242 and Nitzer Ebb.",
      wiki: "https://en.wikipedia.org/wiki/Roland_TR-909", terms: ["Roland TR-909", "EBM"] },
    kickSub: { text: "An 808-school kick tuned down until it is more pressure than hit. Miami bass and early electro discovered you could tune the 808 kick and play basslines with it.",
      wiki: "https://en.wikipedia.org/wiki/Miami_bass", terms: ["Roland TR-808"] },
    kickRust: { text: "A kick pushed into heavy distortion, the industrial move: Ministry and KMFDM overdrove their drum machines until the kick became a wall of grit.",
      wiki: "https://en.wikipedia.org/wiki/Ministry_(band)", terms: ["Distortion", "Industrial music"] },
    snare909: { text: "The TR-909 snare recipe: a detuned tone under a burst of filtered noise. Crank the noise half and it cracks like a whip; techno and EBM both lean on it.",
      wiki: "https://en.wikipedia.org/wiki/Roland_TR-909", terms: ["Roland TR-909"] },
    snareTight: { text: "The dry, close, unglamorous snare of post-punk drum machines. The Sisters of Mercy built a whole catalogue on a machine they credit as a band member: Doktor Avalanche.",
      wiki: "https://en.wikipedia.org/wiki/The_Sisters_of_Mercy", terms: ["Drum machine"] },
    snareGate: { text: "The giant gated-reverb snare of the 80s, found by accident around Peter Gabriel and Phil Collins sessions in 1979: a huge room chopped off mid-bloom. Dark synth-pop borrowed it immediately.",
      wiki: "https://en.wikipedia.org/wiki/Gated_reverb", terms: ["Gated reverb", "Reverb"] },
    snare808: { text: "The 808's papery snare: more tick than crack. Electro and early hip-hop mixed it loud and dry; darker records tuck it under claps.",
      wiki: "https://en.wikipedia.org/wiki/Roland_TR-808", terms: ["Roland TR-808"] },
    snareGlitch: { text: "A snare mangled the way cheap 12-bit samplers mangled everything: short, bright, broken. Skinny Puppy and their peers turned that damage into an aesthetic.",
      wiki: "https://en.wikipedia.org/wiki/Skinny_Puppy", terms: ["Sampler", "Bitcrusher"] },
    snareClap: { text: "Snare and handclap stacked into one hit, the oldest drum-machine mixing trick: the clap widens the snare without costing another track. All over 80s dance records.",
      wiki: "https://en.wikipedia.org/wiki/Drum_machine", terms: ["Drum machine"] },
    hatC: { text: "A closed hat in the 808/909 school, made here from filtered noise. Mixed quiet and tight, it is the metronome of machine music.",
      wiki: "https://en.wikipedia.org/wiki/Hi-hat", terms: ["Roland TR-909"] },
    hatO: { text: "The open hat on the offbeat is disco's engine, inherited by house and synth-pop alike: it pulls the groove forward between the kicks.",
      wiki: "https://en.wikipedia.org/wiki/Hi-hat", terms: ["Swing"] },
    hatTick: { text: "Hats shrunk to a cold tick: the minimal pulse of DAF and early Cabaret Voltaire, where the hi-hat is more clock than cymbal.",
      wiki: "https://en.wikipedia.org/wiki/Cabaret_Voltaire_(band)", terms: ["Drum machine"] },
    hatSizzle: { text: "A long sizzling open hat, the 909's specialty: its hi-hats were real recordings while its drums stayed analog. Ride it through a whole bar for hypnosis.",
      wiki: "https://en.wikipedia.org/wiki/Roland_TR-909", terms: ["Roland TR-909", "Sampler"] },
    clap909: { text: "The synthesized handclap: a few fast noise bursts and a tail, no hands involved. The 808 and 909 versions replaced real claps on a decade of records.",
      wiki: "https://en.wikipedia.org/wiki/Roland_TR-909", terms: ["Roland TR-909"] },
    clapRoom: { text: "A clap pushed through a big room: the drum-computer-through-effects move that gave 80s pop its wide backbeat. Prince ran his Linn LM-1 claps through everything he owned.",
      wiki: "https://en.wikipedia.org/wiki/Linn_LM-1", terms: ["Sampler", "Reverb"] },
    grind: { text: "Industrial percussion began as literal metal: Einstürzende Neubauten played springs, air ducts and power tools; Test Dept raided scrapyards. This burst is that gesture, synthesized.",
      wiki: "https://en.wikipedia.org/wiki/Einst%C3%BCrzende_Neubauten", terms: ["Industrial music"] },
    clank: { text: "Struck metal without the metal: an inharmonic FM burst through a bandpass. Industrial bands sampled radiators and railings; FM synthesis fakes the same clang from math.",
      wiki: "https://en.wikipedia.org/wiki/Frequency_modulation_synthesis", terms: ["FM synthesis", "Industrial music"] },
    anvil: { text: "The anvil hit: industrial's most on-the-nose percussion, and it worked. Ministry-era records punctuate riffs with foundry noise exactly like this.",
      wiki: "https://en.wikipedia.org/wiki/Ministry_(band)", terms: ["Industrial music"] },
    scrape: { text: "A long noise scrape in the spirit of the first industrial records: Throbbing Gristle treated the studio itself as an instrument and melody as optional.",
      wiki: "https://en.wikipedia.org/wiki/Throbbing_Gristle", terms: ["Industrial music"] },
    bassNail: { text: "The relentless sequenced 16th-note bassline is EBM's signature: Nitzer Ebb's 'Join in the Chant' and the Front 242 catalogue run on exactly this, dark, driven, machine-tight.",
      wiki: "https://en.wikipedia.org/wiki/Electronic_body_music", terms: ["EBM", "Sequencer"] },
    bassRubber: { text: "A round Moog-school sub bass: triangle and sine, quick envelope, no fizz. The Minimoog wrote this recipe in 1970 and every synth bass since answers to it.",
      wiki: "https://en.wikipedia.org/wiki/Minimoog", terms: ["Subtractive synthesis"] },
    bassAcid: { text: "The Roland TB-303 sound: a failed bass-player replacement whose cranked resonance and glide invented acid house in 1987 with Phuture's 'Acid Tracks'.",
      wiki: "https://en.wikipedia.org/wiki/Roland_TB-303", terms: ["Roland TB-303", "Resonance", "Glide / Portamento"] },
    bassGrind: { text: "Bass as a distortion instrument: the growl under Nine Inch Nails' 'Pretty Hate Machine' era, where the bassline carries the aggression so the drums don't have to.",
      wiki: "https://en.wikipedia.org/wiki/Pretty_Hate_Machine", terms: ["Distortion", "Industrial music"] },
    bassPluck: { text: "The dry plucky mono bass of early synth-pop: Depeche Mode's first records bounce on exactly this kind of short, polite analog pluck, before their sound turned black.",
      wiki: "https://en.wikipedia.org/wiki/Depeche_Mode", terms: ["Synth-pop"] },
    stabBrass: { text: "Sawtooth brass stabs from the polysynth era (Oberheim, Juno, Jupiter): the rhythmic punctuation of 80s pop, turned minor and mean in the dark half of the decade.",
      wiki: "https://en.wikipedia.org/wiki/Oberheim", terms: ["Stab", "Saw wave"] },
    stabDark: { text: "Minor-key stabs an octave down: the punctuation of goth-adjacent synth rock, Sisters of Mercy to early Cure, where the chord lands like a door slamming.",
      wiki: "https://en.wikipedia.org/wiki/Gothic_rock", terms: ["Stab", "Scale / Minor scale"] },
    leadCold: { text: "A cold sequenced pulse in the New Order school: 'Blue Monday' proved a synth line repeated without mercy could carry a seven-minute hit.",
      wiki: "https://en.wikipedia.org/wiki/Blue_Monday_(New_Order_song)", terms: ["Arpeggio (ARP)", "Pulse / Square wave"] },
    leadHollow: { text: "The lonely hollow square-wave lead runs from Kraftwerk's melodies through OMD to every bedroom synth act since: cheap to make, impossible to ignore.",
      wiki: "https://en.wikipedia.org/wiki/Kraftwerk", terms: ["Pulse / Square wave", "Synth-pop"] },
    leadNeon: { text: "Bright octave-up pulse leads are the neon signage of the mid-80s: Jan Hammer's Miami Vice scores and a hundred title themes. Here it comes slightly poisoned, for the dark palette.",
      wiki: "https://en.wikipedia.org/wiki/Jan_Hammer", terms: ["Pulse / Square wave"] },
    leadBlade: { text: "A wide detuned lead in the Yamaha CS-80 tradition: Vangelis' Blade Runner score made this the official sound of rainy dystopia, which is exactly the mood here.",
      wiki: "https://en.wikipedia.org/wiki/Yamaha_CS-80", terms: ["Saw wave", "Subtractive synthesis"] },
    padWarm: { text: "A slow analog pad in the Roland Juno school. The Juno-60's built-in chorus is why 80s pads shimmer, and why this app's chorus send exists: feed it generously.",
      wiki: "https://en.wikipedia.org/wiki/Roland_Juno-60", terms: ["Pad", "Chorus"] },
    padGlass: { text: "Cold glassy digital pads arrived with the DX7 and Roland's D-50 and instantly dated every string machine: late-80s records drip with this frozen sheen.",
      wiki: "https://en.wikipedia.org/wiki/Roland_D-50", terms: ["Pad", "FM synthesis"] },
    padDark: { text: "Low murky pads doing the job string machines did for Joy Division and the early Cure: a grey fog behind the band. Synthesized here, but the gloom is period-correct.",
      wiki: "https://en.wikipedia.org/wiki/String_synthesizer", terms: ["Pad"] },
    padChoir: { text: "The synthetic choir: the Polymoog 'Vox Humana' preset carried Gary Numan's 'Cars', and sampled Fairlight choirs haunted the rest of the decade. Ghost voices, no throat involved.",
      wiki: "https://en.wikipedia.org/wiki/Polymoog", terms: ["Pad", "Sampler"] },
    padSweep: { text: "A pad built around a slow resonant filter sweep: the Berlin-school gesture Tangerine Dream stretched into whole album sides.",
      wiki: "https://en.wikipedia.org/wiki/Tangerine_Dream", terms: ["Cutoff", "Resonance"] },
    gtrSteel: { text: "A steel-string acoustic conjured by the Karplus-Strong algorithm: a noise burst rings through a tuned delay until it becomes a string. Depeche Mode's 'Personal Jesus' broke synth-pop's no-guitars taboo in 1989.",
      wiki: "https://en.wikipedia.org/wiki/Karplus%E2%80%93Strong_string_synthesis", terms: ["Karplus-Strong"] },
    gtrNylon: { text: "The same synthesized string plucked soft and dark, nylon-style: felt more than heard. Use it where a pad would be too obvious.",
      wiki: "https://en.wikipedia.org/wiki/Classical_guitar", terms: ["Karplus-Strong"] },
    gtrClean: { text: "A clean electric with the top rolled smooth, made for the chorus bus: The Cure and New Order hung whole songs on chorused clean guitar over synth beds.",
      wiki: "https://en.wikipedia.org/wiki/The_Cure", terms: ["Karplus-Strong", "Chorus"] },
    gtrMute: { text: "Palm-muted chug: the string choked to a tick. Big Black wired cheap guitars straight into a drum-machine grid in the mid-80s; this row does the same without the guitar.",
      wiki: "https://en.wikipedia.org/wiki/Big_Black", terms: ["Karplus-Strong", "Power chord"] },
    gtrCrunch: { text: "Mid-gain crunch in the Killing Joke lineage, the guitar tone post-punk handed to industrial: bark, not fizz. Program root and fifth for instant menace.",
      wiki: "https://en.wikipedia.org/wiki/Killing_Joke", terms: ["Power chord", "Distortion"] },
    gtrStack: { text: "The wall: guitars bolted onto sequencers, the blueprint of Ministry's 'The Land of Rape and Honey' that Nine Inch Nails then industrialized further. Send it to the distortion bus and duck.",
      wiki: "https://en.wikipedia.org/wiki/The_Land_of_Rape_and_Honey", terms: ["Industrial music", "Power chord", "Distortion"] },
    fmBell: { text: "An FM bell straight from the DX7 family that rang over every chart from 1983 to 1989: metallic partials no analog filter could make. Here it tolls in a minor key.",
      wiki: "https://en.wikipedia.org/wiki/Yamaha_DX7", terms: ["Yamaha DX7", "FM synthesis"] },
    fmTwang: { text: "The plucked-wire FM tone, cousin of the DX7 bass and pluck presets that quietly ran the late 80s: fast bite, metallic tail.",
      wiki: "https://en.wikipedia.org/wiki/Yamaha_DX7", terms: ["Yamaha DX7", "FM synthesis"] },
    fmScrap: { text: "FM with a non-integer ratio goes inharmonic: struck scrap instead of a note. Industrial adopted FM precisely because it clangs so beautifully when mistreated.",
      wiki: "https://en.wikipedia.org/wiki/Frequency_modulation_synthesis", terms: ["FM synthesis", "Carrier / Modulator"] },
    fmWood: { text: "FM percussion from the marimba-and-woodblock corner of the DX7 preset bank: dry, tuned, oddly polite. Detune it against the clanks for contrast.",
      wiki: "https://en.wikipedia.org/wiki/Yamaha_DX7", terms: ["Yamaha DX7"] },
  },
  ...
  tooltips: {
    ...
    tips: { what: "Turns these hover hints on or off, everywhere in the app.", why: "Learn with hints on; switch them off once the labels are enough and the studio gets quieter." },
    ...
    decay: { what: "How long the plucked string rings, from a choked palm-mute tick to a long open sustain.", why: "Short equals chug, long equals strum: this one knob is the difference between rhythm guitar and texture." },
    bright: { what: "How hard and bright the pluck is, like picking near the bridge with a pick versus brushing with a thumb.", why: "Dark plucks read as nylon and mood; bright ones cut through a dense industrial mix." },
    pick: { what: "Where along the string you pluck; the comb filtering changes which overtones survive.", why: "Middle positions sound hollow and woody, edge positions thin and wiry: free tonal variety with no new notes." },
    body: { what: "How much wooden body resonance sits under the string.", why: "More body reads acoustic; none reads like a solid-body electric plugged straight into the desk." },
    ...
    libInfo: { what: "The story behind this sound: the machine or record it is modeled on, with a link to read more and glossary terms to look up.", why: "Nothing in this library is arbitrary: every preset points at a real instrument or a real record you can go hear." },
    libImport: { what: "Loads short audio files from your computer into the library as playable instruments.", why: "Industrial was built on found sound: a slammed door on the PERC row is more period-correct than any preset. Samples are saved inside your project file." },
    sampleItem: { what: "One of your imported samples. Click to preview it.", why: "Any sound is an instrument once it is on a track: pitch it with the keyboard, mangle it with the sends." },
    sampleRemove: { what: "Removes this sample from the library. A track still using it plays on until the project is reloaded.", why: "Samples live inside your project file, so pruning unused ones keeps that file small." },
  ...
  glossary: [
    ...
    /* ── The machines and scenes behind the library (see the ⓘ notes) ── */
    ["Drum machine", "A sequencer with built-in drum sounds: TR-808, TR-909, LinnDrum, Oberheim DMX. Post-punk made it a band member; the Sisters of Mercy credit theirs, 'Doktor Avalanche', on every record."],
    ["Roland TR-808", "The 1980 drum machine whose synthesized (not sampled) drums flopped on release, then built electro, hip-hop and house. Its kick is a sine wave with a fast pitch drop, exactly how this app makes one."],
    ["Roland TR-909", "The 808's 1983 successor: punchier analog kick and snare, real sampled hi-hats. It became the heartbeat of techno and of the harder end of EBM and industrial dance."],
    ["Roland TB-303", "A tiny 1981 bass synth built to replace bass players. It failed at that, then invented acid house when producers cranked its resonance: the squelch is its filter singing."],
    ["Yamaha DX7", "The 1983 FM synthesizer that put digital bells, electric pianos and glassy pads on practically every late-80s record. So hard to program that most artists shipped the presets."],
    ["Sampler", "An instrument that records a sound and replays it at any pitch. The 8-bit and 12-bit samplers of the 80s (Fairlight, Emulator, Akai) are where the bitcrusher's crunch comes from; IMPORT AUDIO lets you work the same way."],
    ["Gated reverb", "A huge reverb chopped off mid-bloom by a noise gate: the giant 80s drum sound, discovered by accident around Peter Gabriel and Phil Collins sessions in 1979 and stamped on the whole decade."],
    ["Karplus-Strong", "A 1983 algorithm that turns a burst of noise into a plucked string: the noise circulates through a short delay, loses treble on every pass, and rings into a pitch. Every guitar in this app is Karplus-Strong; no recordings anywhere."],
    ["Power chord", "Root plus fifth with no third: neither major nor minor, just mass. The building block of distorted guitar riffs, and it survives heavy distortion where full chords turn to mud."],
    ["Industrial music", "Born in the mid-70s around Throbbing Gristle (who named it): noise, machinery and found sound treated as music. By the late 80s it had fused with dance music and metal into the sound this app chases."],
    ["EBM", "Electronic Body Music: the dancefloor end of industrial (Front 242, Nitzer Ebb, DAF). Relentless sequenced 16th-note basslines, machine drums, shouted commands."],
    ["Synth-pop", "Pop built on synthesizers instead of guitars, from Kraftwerk to Depeche Mode. Its dark wing (minor keys, cold timbres, drum machines) is the other half of this app's palette."],
  ],
